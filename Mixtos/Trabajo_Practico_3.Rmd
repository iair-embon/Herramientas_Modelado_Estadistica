...
k_optimo_finder <- function(modelo_gam, potenciales_k){
  ...
  pmap(potenciales_k,
    ...
    unlist( #Convierto el resultado de nuevo en un vector
      lapply(
        potenciales_k, function(x) x[.] #Itero por todos los elementos de la lista para sacar el indice de los valores optimos de k
        )
           ) 
}
```
