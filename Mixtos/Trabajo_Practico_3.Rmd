...
Ahora armamos un dataframe para ver bien cual es exactamente el modelo que tiene la menor media pero tambien graficamos el desvio de los datos para tratar de captar que tanta variacion hubo con los distintos folds. Asi finalmente podemos elegir el modelo que mas nos convence.
